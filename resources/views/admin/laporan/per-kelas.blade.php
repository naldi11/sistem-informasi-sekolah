    ...
    <div class="card mb-3 shadow-sm border-0">
        <div class="card-body">
            <form method="GET">
                <div class="row g-2">
                    <div class="col-md-3">
                        <label class="form-label fw-semibold text-muted" style="font-size:0.8rem;"><i class="bi bi-door-open me-1"></i>Pilih Kelas <span class="text-danger">*</span></label>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 border-top pt-2 mt-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.laporan.perKelas') }}" class="btn btn-light btn-sm px-3 border text-secondary">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.laporan.exportPdf', array_merge(['type' => 'per-kelas'], request()->all())) }}" class="btn btn-danger btn-sm px-3 fw-medium">
                            <i class="bi bi-file-pdf-fill me-1"></i>Export PDF
                        </a>
                        <a href="{{ route('admin.laporan.exportExcel', array_merge(['type' => 'per-kelas'], request()->all())) }}" class="btn btn-success btn-sm px-3 fw-medium">
