                    ...
                    <table class="table table-hover mb-0 align-middle table-responsive-text" id="tabelRiwayat">
                        ...
                        <tbody>
                            @forelse($riwayat as $t)
                                <tr>
                                    <td class="px-2 px-sm-3 responsive-text">
                                        <div class="fw-bold">{{ $t->bulan_str }}</div>
                                        @if($t->isMulti)
                                            <span class="badge bg-info bg-opacity-10 text-info border border-info mt-1" style="font-size:0.65rem;">
                                                <i class="bi bi-layers me-1"></i>Multi-Bulan ({{ $t->count }} Bln)
                                            </span>
                                        @endif
                                    </td>
                                    <td class="text-nowrap fw-bold px-2 px-sm-3 responsive-text">Rp {{ number_format($t->nominal_total, 0, ',', '.') }}</td>
